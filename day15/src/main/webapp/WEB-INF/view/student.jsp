...
<body class="gray-bg">
	...
	<!-- 新增教师-->
	<div class="modal fade" id="modal_user_add" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_teacher" method="post" action="reserveTeacher.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>教师姓名：</td>
								<td><input type="text" id="username" name="name"
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_tea_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    $("#submit_form_tea_btn").click(function(){
	    	$("#form_teacher").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addteacher").click(function(){
	    		$("#form_teacher").resetForm();
	    		$('#modal_user_add').modal({backdrop: 'static', keyboard: false});
